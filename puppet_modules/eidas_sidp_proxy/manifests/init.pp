class eidas_sidp_proxy (
  ...
  String $dsf_gateway_url                         = $eidas_sidp_proxy::params::dsf_gateway_url,
  ...
  Integer $eidas_sidp_proxy_timeout               = $eidas_sidp_proxy::params::eidas_sidp_proxy_timeout,
  Integer $eidas_sidp_proxy_retry_count           = $eidas_sidp_proxy::params::eidas_sidp_proxy_retry_count,
