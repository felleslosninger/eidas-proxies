class eidas_sidp_proxy (
  ...
  Integer $dsf_gateway_timeout                    = $eidas_sidp_proxy::params::dsf_gateway_timeout,
  Integer $dsf_gateway_retry_count                = $eidas_sidp_proxy::params::dsf_gateway_retry_count,
