...
public class IdPortenAuthnResponseCreatorTest {
    ...
    @Before
    public void setUp() {
        reset(configProvider, instantIssuer, eidasResponse, auditLog, idPortenKeyProvider, auditLog, mfService);
        SamlBootstrap.init();
        ...
        responseCreator = new IdPortenAuthnResponseCreator(configProvider, instantIssuer, idPortenKeyProvider, auditLog, () -> authState, mfService);
